  ...
  <UtilsResponsiveOverlay v-model="isOpen" max-width="520" variant="form" scrollable>
    <v-card class="rounded-xl pa-6 bg-white" elevation="0">
      <div class="responsive-dialog-header mb-5">
        ...
        <v-btn icon variant="text" color="grey-darken-1" size="small" aria-label="Fechar tarefa" @click="$emit('close')">
...
defineProps<{
  ...
  taskForm: { title: string; description: string; priority: string; assigneeId: string };
